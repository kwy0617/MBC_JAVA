...
public class Variable1 {
	...
	public static void main(String[] args) {
	    ...
	    // 변수 선언은
		// [데이터타입] [변수명]:
		// int age;  // age라는 이름의 int 데이터 타입의 변수 언언.
		// age = 10; // age라는 변수에 10값을 대입합니다.
		int age;
		age = 100;
		System.out.println(age);  // sysout + type name = new type();
...
//		System.out.println("나의 몸무게 : "+weight);
		...
		// 정수 타입 데이터
		// byte(1byte),shrt(2byte),char(2byte),int(4byte),long(8byte)
		byte a = 100;
		short b = -100;
		char c = 1000;  // 문자로 사용. ''를 이용
		char d = 'A' ;  // 0 ~ 65535 사이 값.(유니코드)
		int e = 2147483647; // 에러 발생...
		long f = 2147483647L;
