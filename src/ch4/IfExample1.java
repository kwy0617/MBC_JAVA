package ch4;
	 ...
	 *	1. _ 를 활욜해서 두 단어 이상의 이어진 변수 또는 메서드 명을 지정합니다.
	 *	  이유? 변수명에서는 " " 을 사용하면 안됨.
...
public class IfExample1 {
	...
	public static void main(String[] args) {
		...
		// 단순 if
		if ( a == 0 ) {
			System.out.println("딘순 if 문 실행됨...");
		}
		...
		if ( a == 0 ) {	// a == o일 때
			...
			System.out.println("a가 0, 11, 12 아닌 경우 출력");
		}
