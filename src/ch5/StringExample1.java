...
public class StringExample1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(test.equals(hobby2));	// 문자열을 비교할때는 equals() 사용하세요.
		...
		System.out.println("world는 str2d의 몇번 째 인덱스 위치인가? " + world_index);
		
		// 4. substring() : 문자열을 원하는 만큼 자른다.
		// substring(index값) => 해당 인덱스 이후 값을 짤라준다.
		...
		str = "apple/banna/kiwi/lemon/orage";
		...
		// 9. IastIndexOf() : 해당 문자를 뒤에서부터 찾아서 위치를 반환...
		str = "abcd dcba";
		System.out.println("indexof(\"d\") : " + str.indexOf('d'));
		System.out.println("lastIndexOf(\"d\") : " + str.lastIndexOf('d'));
		
		// 두번째 "d"를 IndexOf를 통해서 확인하는 방법...
		System.out.println("indexOF(\"d\")의 두번째ㅑ 위치 : " + str.indexOf('d', 4));
		System.out.println("indexOF(\"d\")의 세번째ㅑ 위치 : " + str.indexOf('d', 6));
		// 인덱스 값이 -1 인 경우에은 검색한 내용이 없는 경우...
		
		// indexOf()를 사용하여 모든 내용을 검색하는 방법
		str = "apple/kiwi/apple/ornge/lemon";
		int idx = 0;
		...
		}else if (str.endsWith(".htm1") || str.endsWith(".htm")) {
