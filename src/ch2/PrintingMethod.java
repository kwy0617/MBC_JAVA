...
public class PrintingMethod {
	...
	public static void main(String[] args) {
		...
		// 2. print (System.out.print(sodyd
		// 괄호 안에 내용을 출력하세요. 줄바꿈x
		System.out.println("나는\n오늘 아침을\n먹었다");
		// 3. printf (System.out.printf(내용, 값1, ...))
		// 형식 문자열에서 %와 conversation(변환문자)를 필수로 작성하고, 나머지 생략가능...
		//  [%argument_index%][flags][width][.pracision]conversation
		// conversation의 종류...
		// %d : 10진수 정수
		// %o : 8진수 정수
		// %x : 16진수 정수
		...
		System.out.printf("%-20.3f\n", c);	// 20칸 확보 후 소수점 3자리까지 출력, 왼쪽 정력

		// 문자열 출력
		String str = "Hello. world!!!";
		System.out.printf("%s\n",str);		// 문자열 출력
		System.out.printf("%30s\n", str);	// 30칸 확보 후 출력
		System.out.printf("%-30s\n", str);	// 30칸 확보 후 출력, 왼쪽 정력
