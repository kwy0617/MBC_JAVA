...
public class ArraysExample2 {
	...
	public static void main(String[] args) {
		...
		// 2차원 배열 : 배열의 요소를 int[]로 가지고 있는 배열
		int[][] arr2 = {
				{1, 2, 3},	// arr2[0]
				{4, 5, 6},	// arr2[1]
				{7, 8, 9},	// arr2[2]
...
//		int[][][] arr3 = {arr2, arr2, arr2, arr2};
		...
		// 카운트 변수와 증감식을 사용하지 않고, 할목의 개수만큼 반복한 후에 자동으로 for문을 빠져나감.
